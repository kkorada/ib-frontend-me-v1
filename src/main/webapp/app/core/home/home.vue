                    ...
                    <div class="col-md-3">
                       ...
                       <div class="ads-column d-none d-sm-block">
                           ...
                           <div class="block one"> 
                               ...
                               <span><font-awesome-icon style="font-size: 40px; margin-right: 12px; color: #c47a95" icon="phone-volume"></font-awesome-icon></span>                               
                               <h4>Call Now 0900 - 00 24</h4>
                            </div>
                            <div class="block two">
                                <div class="part1">
                                    <h4> Preffered Banking</h4>
                                    <button class="btn btn-ib col-md-12">Make an appointment</button>
                                </div>
                                <div class="part2">
                                    <ul class="ad-menu">
